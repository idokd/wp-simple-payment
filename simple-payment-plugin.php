   ...
   */
    ...
    function gutenberg_assets() { // phpcs:ignore
      wp_register_style(
        ...
        array( 'wp-editor' ), 
        null // filemtime( plugin_dir_path( __DIR__ ) . 'dist/blocks.style.build.css' ) // Version: 1.6.1File modification time.
      );
      wp_register_script(
        ...
        null, // filemtime( plugin_dir_path( __DIR__ ) . 'dist/blocks.build.js' ), // Version: 1.6.1filemtime — Gets file modification time.
        true 
      );
      wp_register_style(
        ...
        null // filemtime( plugin_dir_path( __DIR__ ) . 'dist/blocks.editor.build.css' ) // Version: 1.6.1File modification time.
      );
      wp_localize_script(
        'simple-payment-gb-block-js',
