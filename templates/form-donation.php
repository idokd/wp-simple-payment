  ...
  <div class="mb-3">
    <div class="row">
        <div class="col-md-6 mb-3">
         <label for="donation"><?php _e('Donation Concept', 'simple-payment'); ?></label>
          <input type="text" class="form-control" id="donation" name="product" value="<?php echo esc_attr( $product ); ?>" />
        </div>
        <div class="col-md-6 mb-3">
          <label for="amount"><?php echo esc_html( $product ); ?></label>
          <input type="text" class="form-control" id="amount" name="amount" value="<?php echo esc_attr( $amount ); ?>" />
        </div>
    </div>
  ...
  <h4 class="mb-3"><?php _e('Billing Information', 'simple-payment'); ?></h4>
    <div class="row">
      <div class="col-md-6 mb-3">
        ...
        <input type="text" class="form-control" id="firstName" name="<?php echo esc_attr( $SPWP::FIRST_NAME ); ?>" placeholder="" value="" required="">
